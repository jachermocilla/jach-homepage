...
develop simulations and user space applications partly because of the large
source code base of modern real-world operating systems. A better approach
would be for the students to code parts of an actual working operating system
and see their program run at the kernel level. This paper presents the 
...
offered, the students were able to create interesting projects that demonstrate
