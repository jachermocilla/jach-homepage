...
addition, the prerequisite knowledge needed make have not been grasped by the 
students. To write an operating system from scratch, one has to have knowledge
of the processor, assembly language, data structures, and C programming.
