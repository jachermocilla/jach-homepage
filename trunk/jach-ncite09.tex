...
the DEX-OS kernel which has a smaller source code base but can run on real
hardware. The students were able to demonstrate a deeper understanding of 
how an real operating system works by their succesful implementation of
