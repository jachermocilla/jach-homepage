...
For this activity, students were asked to develop an external program, 
which not part of the shell, that can be executed from within ICS-OS. 
They created their program folder within the contrib/ directory, 
for example hello/, and copied the sample Makefile in 
