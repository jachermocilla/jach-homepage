...
DEX-OS, is a fully functional operating system with a small source code base 
which makes it ideal for teaching. Traditional teaching approaches has relied 
on simulations and user space application development. These are not enough 
since students do not see their programs working at the kernel level. At
