...
undergraduates, as in the case of the author's institution, do not involve 
...
proposed and developed. The next section briefly reviews these.

One criteria for choosing the operating system to use is the completeness 
...
memory management, filesystems, a shell, will unlikely be a good choice. Also,
an operating system with several thousands of lines of code and a complicated
source directory structure will confuse students and thus will consume more
time to understand.
