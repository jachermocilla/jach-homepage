...
ICS-OS, based on the DEX-OS kernel, is a functional operating system with a
small source code base making it suitable for teaching. At the end of the 
semester the course was offered, the students were able to create interesting
projects that demonstrate their understanding and appreciation.
\end{abstract}
