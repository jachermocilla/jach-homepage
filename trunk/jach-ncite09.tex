...
the DEX-OS kernel which has a smaller source code base making it ideal for
instruction. The students were able to demonstrate a deeper understanding of 
how a real operating system works by their succesful implementation of
projects to extend and enhance ICS-OS.
\end{abstract}
