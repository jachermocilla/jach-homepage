...
Los Ba\~nos. The students are in their third year and has completed the data 
structures and assembly language courses.
...
\subsection{Minix}
Minix\cite{tanenbaum:minix} has been around for several years already and has been the running 
example in the textbook, Operating Systems: Design and Implementation\cite{tanenbaum:osdsai}. Since its initial release, Minix has grown in size in terms
