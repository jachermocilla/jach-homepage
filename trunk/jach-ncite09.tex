...
Similar to the linux philosophy, one can think of ICS-OS as a distribution that
is based on the DEX-OS kernel. ICS-OS provides an easy environment for learning 
operating systems by kernel programming. A set of tools and utilities were
provided to make it easy for students to write kernel code and see them work as
