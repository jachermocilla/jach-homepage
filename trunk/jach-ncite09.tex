...
asked to modify the function  console\_execute() by adding the following simple
code fragment.
...
In this actvity, students were asked to develop a simple program that can 
be executed from within ICS-OS. They created their program folder within
the contrib/ directory and copied the Makefile. The following commands built 
their program and prepared the executable for installation later.
