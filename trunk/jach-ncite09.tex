...
however are in user space. Students will be more interested in writing kernel 
code.
...
by the user manually through a shell or by initialization scripts. The shell
in ICS-OS is implemented in the kernel.
