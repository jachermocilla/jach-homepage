...
The main components of DEX-OS are memory manager, process manager, device
...
the source code base has to migrated to linux first. To accomplish this, the
linker script has to be modified, as well as the Makefile.   
