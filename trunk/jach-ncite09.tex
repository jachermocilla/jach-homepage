...
A user application was developed to test the system call directly by invoking
...
\section{Conclusion}
In this paper, the author has presented ICS-OS as an instructional operating 
system for teaching operating systems concepts to undergraduate students. 
A high success rate in the students projects indicate that a kernel programming
approach is better in making them understand operating system concepts.
