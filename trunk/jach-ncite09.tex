...
no longer required since the test machine is a software application running on
the development machine itself.
 
Delivery of an operating systems course is usually through a lecture and 
a laboratory component. A popular textbook used by instructors is the 
dinosaur book by Silberschatz and Galvin \cite{silberschatz:osc}.
