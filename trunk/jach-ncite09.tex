...
development process, a Makefile was created to perform the building 
automatically. 
...
In this actvity, students were asked to develop a simple
program that can be executed from within ICS-OS. 
