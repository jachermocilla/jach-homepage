...
and large source code base. This paper presents the experiences and results of
using ICS-OS to teach an undergraduate operating systems course. ICS-OS is 
based on the DEX-OS kernel which has a smaller source code base making it ideal
for instruction. The students were able to demonstrate a deeper understanding
