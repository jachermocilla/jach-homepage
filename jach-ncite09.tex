...
systems design and implementation.ICS-OS is largely based on DEX-OS, thus
it warrants a more elaborate discussion. The following are the main components
of DEX-OS.
...
\testit{Shell}
The shell provides users with a command line to access the services provided by
...
available on the development machine. Thus, a linux environment was chosen.
However, the original development environment for DEX-OS was in Window so
the source code base has to migrated to linux first.
