...
main components of DEX-OS are memory manager, process manager, device manager,
...
After the development environment is setup, the students were given activities
to build ICS-OS.

\subsubsection{Download and Test}
The students were asked to download the ICS-OS source code from google code
project hosting site \cite{icsos:site}.
