...
Not all students are fluent in programming. Some even find it
difficult to code user level applications.

Exposes how an operating system works from the bare metal (real hardware)

Students were able to see the big picture on how a computer system works

Understand the separation of kernel and user space
...
In conclusion, operating systems concepts
