...
systems design and implementation.ICS-OS is largely based on DEX-OS. The
following are the main components of DEX-OS. 
...
available on the development machine. A linux environment can provide these.
However, the original development environment for DEX-OS was in Windows so
