...
Since GRUB supports compressed kernel images, it further reduces the size of
the kernel and the distribution itself. ICS-OS can fit in a single floppy disk.
