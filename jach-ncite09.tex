...
directory and copied the sample Makefile in it. The Makefile for hello.exe is 
is shown above. The hello.c source file which contains the application logic,
should reside in the hello/ folder. The build and installation process is 
shown below.

\begin{verbatim}
/contrib/hello$make
/contrib/hello$make install
\end{verbatim}
