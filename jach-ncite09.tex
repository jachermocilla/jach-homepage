...
Lastly, since ICS-OS was presented only during the second half of the semester,
the students did not have enough time to explore and study the source code of
ICS-OS.

The use of ICS-OS in teaching operating systems concepts has achieved the 
following objectives.

\begin{itemize}
\item{Exposes how an operating system works from the bare metal 
(real hardware)}
...
\item{Understand how system calls work and the advatages of using}
\item{application programming interfaces and software development kits.}
\end{itemize}

Understand how system calls work and the advatages of using
application program interfaces and software development kits.
